...
const Programs = () => {
  ...
  const bidangColors = {
    ...
    "Ristek": "bg-bem-gold/10 text-bem-gold-dark border-bem-gold/20",
      ...
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-bem-black mb-4">
            Program <span className="text-bem-gold">Kerja</span>
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
          <Card className="text-center border-0 shadow-elegant">
            <CardContent className="p-6">
              <div className="text-2xl font-bold text-bem-gold mb-1">13</div>
              <p className="text-bem-gray text-sm">Program Kerja</p>
            </CardContent>
          </Card>
          <Card className="text-center border-0 shadow-elegant">
            <CardContent className="p-6">
              <div className="text-2xl font-bold text-bem-gold mb-1">5</div>
              <p className="text-bem-gray text-sm">Bidang</p>
            </CardContent>
          </Card>
          <Card className="text-center border-0 shadow-elegant">
            <CardContent className="p-6">
              <div className="text-2xl font-bold text-bem-gold mb-1">10</div>
              <p className="text-bem-gray text-sm">Bulan</p>
            </CardContent>
          </Card>
          <Card className="text-center border-0 shadow-elegant">
            <CardContent className="p-6">
              <div className="text-2xl font-bold text-bem-gold mb-1">2025</div>
                ...
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      <Calendar className="h-4 w-4 text-bem-gold" />
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-bem-black text-center mb-8">
            Timeline <span className="text-bem-gold">2025</span>
          </h2>
          
          <div className="relative max-w-4xl mx-auto">
            <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-bem-gold/30 transform md:-translate-x-px"></div>
            
            {programs.slice(0, 8).map((program, index) => (
              <div key={index} className="relative flex items-center mb-8">
                <div className="absolute left-4 md:left-1/2 w-3 h-3 bg-bem-gold rounded-full transform md:-translate-x-1/2 z-10"></div>
