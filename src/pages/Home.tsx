    ...
    <main className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-r from-bem-black via-bem-black-light to-bem-black py-20 px-4">
        <div className="container mx-auto text-center">
          <div className="mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-bem-gold to-bem-gold-dark mb-6">
              <span className="text-white font-bold text-2xl">BEM</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">
              BEM FST <span className="text-bem-gold">UNSAM</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/program">
                <Button className="bg-bem-gold hover:bg-bem-gold-dark text-white px-8 py-3 text-lg">
                  Lihat Program Kerja
                </Button>
              </Link>
              <Link to="/profil">
                <Button variant="outline" className="border-bem-gold text-bem-gold hover:bg-bem-gold hover:text-white px-8 py-3 text-lg">
                  Tentang Kami
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-0 shadow-elegant">
              <CardHeader>
                <div className="flex items-center gap-3 mb-4">
                  <Target className="h-8 w-8 text-bem-gold" />
            ...
            <Card className="border-0 shadow-elegant">
              <CardHeader>
                <div className="flex items-center gap-3 mb-4">
                  <Heart className="h-8 w-8 text-bem-gold" />
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-20 h-1 bg-bem-gold mx-auto"></div>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <Card className="text-center border-0 shadow-elegant group hover:shadow-gold transition-all duration-300">
              <CardContent className="p-6">
                <div className="w-16 h-16 rounded-full bg-bem-gold/10 flex items-center justify-center mx-auto mb-4">
                  <Users className="h-8 w-8 text-bem-gold" />
                </div>
            ...
            <Card className="text-center border-0 shadow-elegant group hover:shadow-gold transition-all duration-300">
              <CardContent className="p-6">
                <div className="w-16 h-16 rounded-full bg-bem-gold/10 flex items-center justify-center mx-auto mb-4">
                  <Award className="h-8 w-8 text-bem-gold" />
                </div>
